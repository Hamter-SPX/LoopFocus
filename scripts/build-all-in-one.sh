...

{
  ...
  for f in "$ROOT"/references/state-machine.md "$ROOT"/references/gate-engine.md "$ROOT"/references/effort-elasticity.md "$ROOT"/references/dynamic-focus-depth.md "$ROOT"/references/skillfocus.md "$ROOT"/references/canvas.md "$ROOT"/references/predictive-analysis.md "$ROOT"/references/security-mode.md "$ROOT"/references/build-mode.md "$ROOT"/references/verification-and-claim-governance.md "$ROOT"/references/toolbus.md "$ROOT"/references/loop-control/*.md "$ROOT"/references/reasoning/*.md "$ROOT"/references/goal/*.md "$ROOT"/references/progress/*.md "$ROOT"/references/state-memory/*.md "$ROOT"/references/knowledge/*.md; do
    echo
